...
const allQuestions = [
  ...
  { ch:"ch1", diff:"medium", q:"A company should not always target all possible customers. Which kind of customer is not the most valuable to a company, but, can over time, contribute to the firm's success?", opts:["butterflies", "shooting stars", "barnacles", "true friends", "strangers"], ans:2, exp:"Barnacles = ولاء عالٍ + ربحية منخفضة. يبقون 'over time' بسبب ولائهم، وإن لم يكونوا الأكثر ربحية — لكن الشركة يمكنها محاولة رفع ربحيتهم تدريجياً. Butterflies لا يبقون (ولاء منخفض)." , expW:{0:"Butterflies = ربحية↑ لكن ولاء↓ — لا يبقون over time، استفد منهم مؤقتاً فقط", 1:"Shooting stars = ليست مجموعة CRM معروفة", 3:"True friends = ولاء↑ + ربحية↑ — أفضل العملاء وأكثرهم قيمة", 4:"Strangers = ولاء↓ + ربحية↓ — لا تستثمر فيهم"} },
  ...
  { ch:"ch5", diff:"easy", q:"Consumer information provider Nielsen uses a life-stage segmentation system that places U.S. households into one of 66 different life-stage groups. According to Nielsen's groups, which of the following refers to the group consisting of hip, single twenty-somethings who are politically liberal, listen to alternative music, and enjoy lively nightlife?", opts:["Striving Singles", "Young Achievers", "Bohemian Mix", "Young Influentials", "Young Digerati"], ans:4, exp:"Young Digerati = الشباب العازبون في العشرينيات، ليبراليون سياسياً، يستمعون للموسيقى البديلة ويستمتعون بالحياة الليلية — يسكنون الأحياء العصرية ومتفاعلون تقنياً واجتماعياً. هذا التوصيف يطابق Kotler (Pearson Test Bank)." , expW:{0:"Striving Singles = عزاب يكافحون في ظروف مالية صعبة",1:"Young Achievers = عائلات شابة مستقرة في الضواحي بدخل مريح — لا تنطبق عليهم صفة 'ليبراليون + موسيقى بديلة'",2:"Bohemian Mix = متنوعون حضرياً مع تنوع عرقي وتقاليد فنية",3:"Young Influentials = شباب طموحون يميلون للمحافظة"}},
...
const pastQuestions = [
  ...
  { ch:"ch5", diff:"easy", q:"Which of the following is the term for customers who make repeat purchases and tell others about their positive experiences with a product or service?", opts:["prospects","barnacles","highly satisfied customers","butterflies"], ans:2, exp:"العملاء الراضون جداً (highly satisfied customers) هم من يكررون الشراء ويخبرون الآخرين بتجاربهم الإيجابية." },
