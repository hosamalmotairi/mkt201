...
const flashCards = [
  ...
  { ch:"ch3", front:"Uncontrollable (Marketing Environment)", back:"Companies that view the marketing environment as uncontrollable passively accept it, analyze environmental forces, and design strategies to avoid threats and take advantage of opportunities — same as the Reactive Approach." , exp:"Uncontrollable = نظرة الشركة للبيئة التسويقية على أنها لا يمكن السيطرة عليها → تقبّلها سلبياً وتصمم استراتيجيات للتكيّف. مرادف لـ Reactive Approach." },
  ...
  { ch:"ch1", front:"Customer-Perceived Value", back:"The difference between total customer perceived benefits and total customer cost. Customers act on perceived value — they don't always judge value accurately or objectively. Example: a Patek Philippe watch at $20,000+ is 'great value' if perceived benefits exceed the price." },
  { ch:"ch1", front:"Customer Satisfaction", back:"The extent to which a product's perceived performance matches a buyer's expectations. Performance < Expectations = Dissatisfied. Performance = Expectations = Satisfied. Performance > Expectations = Delighted. Key: companies should aim to DELIGHT, not just satisfy." },
  { ch:"ch1", front:"Internet of Things (IoT)", back:"The network where everything is connected to everything else — smartphones, cars, appliances, even clothing. Created a new world of digital marketing. Companies that don't keep up with IoT technology may find their products outdated." },
  { ch:"ch3", front:"Demographic Environment", back:"Study of human populations in terms of size, density, location, age, gender, race, and occupation. People make up markets. Most important demographic trend = generational differences (Baby Boomers vs. Millennials vs. Gen Z)." },
  { ch:"ch5", front:"Motivation Research", back:"Qualitative research designed to probe consumers' hidden, subconscious motivations. Consumers often can't tell you WHY they buy — motivation research digs deeper using techniques like in-depth interviews and projective tests." },
  { ch:"ch5", front:"Subliminal Advertising", back:"The idea that marketers embed hidden messages in ads that consumers perceive subconsciously without awareness. Exam key: most marketers and researchers agree subliminal advertising does NOT work as popularly imagined — its existence and effectiveness are disputed." },
  { ch:"ch5", front:"Customer Journey", back:"The sum of ongoing experiences consumers have with a brand that affect their buying behavior, engagement, and brand advocacy over time. The buying process starts BEFORE and continues AFTER the actual purchase. Differs from the 5-Stage Process (one purchase) — the journey covers ALL interactions over time." },
  ...
  { ch:"ch3", front:"Generational Marketing", back:"Segmenting people by lifestyle or life stage rather than age alone. Five U.S. generational cohorts: Baby Boomers (1946–1964) — largest affluent group; Generation X (1965–1980); Millennials/Gen Y (1981–1996) — first digital natives; Generation Z (1997–2012) — mobile-first; Generation Alpha (after 2012). Each cohort shares values shaped by common world events." },
...
const allQuestions = [
  ...
  { ch:"ch1", diff:"medium", q:"A company should not always target all possible customers. Which kind of customer is not the most valuable to a company, but, can over time, contribute to the firm's success?", opts:["butterflies", "shooting stars", "barnacles", "true friends", "strangers"], ans:0, exp:"Butterflies = مربحون لكن غير مخلصين. تستطيع الشركة الاستفادة منهم مؤقتاً لكنهم ليسوا الأكثر قيمة على المدى البعيد — يساهمون في النجاح عند ظروف مثلى ثم تنتهي العلاقة." , expW:{1:"Shooting stars = ليست مجموعة CRM معروفة", 2:"Barnacles = ولاء↑ + ربحية↓ — حاول رفع ربحيتهم", 3:"True friends = ولاء↑ + ربحية↑ — أفضل العملاء", 4:"Strangers = ولاء↓ + ربحية↓ — لا تستثمر فيهم"} },
  ...
  { ch:"ch3", diff:"medium", q:"Josie's FarmFresh creates sustainable, all-natural food products. These products are most likely to become popular with which group?", opts:["SOHO", "environmentally conscious", "health-focused families", "business", "Millennials'"], ans:1 , exp:"المستهلكون المهتمون بالبيئة = شريحة سوقية متنامية تفضل المنتجات الطبيعية والمستدامة — هدف رئيسي لـ Josie's FarmFresh." , expW:{0:"SOHO = عاملون من المنزل — لا يتمحور اهتمامهم حول الاستدامة", 2:"الأسر المهتمة بالصحة قريبة لكن الإجابة الأشمل هي الوعي البيئي", 3:"Business market = يشترون للإنتاج لا للاستهلاك الشخصي", 4:"Millennials = شريحة تهتم بالبيئة لكن ليست الأدق للمنتجات الطبيعية"} },
  ...
  { ch:"ch5", diff:"easy", q:"Consumer information provider Nielsen uses a life-stage segmentation system that places U.S. households into one of 66 different life-stage groups. According to Nielsen's groups, which of the following refers to the group consisting of hip, single twenty-somethings who are politically liberal, listen to alternative music, and enjoy lively nightlife?", opts:["Striving Singles", "Young Achievers", "Bohemian Mix", "Young Influentials", "Young Digerati"], ans:1, exp:"Young Achievers = الشباب العازبون في العشرينيات، ليبراليون سياسياً، يستمعون للموسيقى البديلة ويستمتعون بالحياة الليلية. هذا التوصيف يطابق Nielsen (Pearson Test Bank Q43 → Answer B)." , expW:{0:"Striving Singles = عزاب يكافحون في ظروف مالية صعبة",2:"Bohemian Mix = متنوعون حضرياً مع تنوع عرقي وتقاليد فنية",3:"Young Influentials = شباب طموحون يميلون للمحافظة",4:"Young Digerati = متميزون تقنياً يسكنون الأحياء الراقية"}},
  ...
  { ch:"ch3", diff:"medium", q:"TRUE or FALSE: Local publics include consumer organizations, environmental groups, minority groups, and others.", opts:["True","False"], ans:1, past:true, exp:"خطأ — ما وصفه السؤال هو Citizen-Action Publics (منظمات المستهلكين، المجموعات البيئية، الأقليات). أما Local Publics فهم الجيران والمنظمات المجتمعية المحيطة بالشركة. الفرق مهم في الاختبار.", expW:{0:"False لأن هذا الوصف ينطبق على Citizen-Action Publics وليس Local Publics"} },
...
const pastQuestions = [
  ...
  { diff:"easy", q:"TRUE or FALSE: Local publics include consumer organizations, environmental groups, minority groups, and others.", opts:["True","False"], ans:1, exp:"خطأ — ما وصفه السؤال هو Citizen-Action Publics (منظمات المستهلكين، المجموعات البيئية، الأقليات). أما Local Publics فهم الجيران والمنظمات المجتمعية المحيطة بالشركة.", expW:{0:"False لأن هذا الوصف ينطبق على Citizen-Action Publics وليس Local Publics"} },
  ...
  // ── اختبار 447 الترم الاول ──
  { ch:"ch1", diff:"easy", q:"Which of the following is the term for customers who make repeat purchases and tell others about their positive experiences with a product or service?", opts:["prospects","barnacles","customer evangelists","butterflies"], ans:2, exp:"Customer evangelists = العملاء الذين يكررون الشراء ويُبشّرون بتجاربهم الإيجابية لدائرتهم الاجتماعية الواسعة. هذا هو المصطلح الدقيق في كوتلر (Pearson Test Bank Q87 → Answer B)." },
  { ch:"ch1", diff:"easy", q:"______ is defined as the customer's evaluation of the differences between all the benefits and all the costs of a marketing offer relative to those of competing offers.", opts:["Marketing myopia","Customer equity","Customer-perceived value","Customer satisfaction"], ans:2, exp:"القيمة المدركة للعميل = تقييمه للفرق بين فوائد وتكاليف العرض مقارنةً بالعروض المنافسة." },
  { ch:"ch2", diff:"easy", q:"______ are high-growth, high-share businesses or products requiring heavy investment to finance rapid growth. They will eventually turn into cash cows.", opts:["Question marks","Cash cows","Dogs","Stars"], ans:3, exp:"النجوم = وحدات أعمال عالية النمو وعالية الحصة تحتاج استثماراً ضخماً وستتحول لأبقار نقدية." },
  { ch:"ch1", diff:"easy", q:"Sellers suffer from ______, the mistake of paying more attention to the specific products they offer than to the benefits and experiences produced by these products.", opts:["value delivery network","value chain","downsizing","marketing myopia"], ans:3, exp:"قصر النظر التسويقي = خطأ التركيز على المنتج ذاته بدلاً من الفوائد التي يقدمها للعميل." },
  { ch:"ch5", diff:"easy", q:"Consumer buyer behavior is the buying behavior of final consumers for:", opts:["personal consumption","industrial use","governmental use","agricultural use"], ans:0, exp:"سلوك المستهلك = سلوك الشراء للمستهلكين النهائيين من أجل الاستهلاك الشخصي." },
  { ch:"ch2", diff:"medium", q:"Which of the following is NOT a problem with BCG matrix approach?", opts:["Focus on future, not current planning","Expensive","Accuracy","Time consuming"], ans:0, exp:"التركيز على المستقبل ليس عيباً في BCG — بل العيب هو تركيزها على الحاضر." },
  { ch:"ch5", diff:"easy", q:"The set of basic values, perceptions, wants, and behaviors learned by a member of society from family and other important institutions:", opts:["culture","subculture","reference group","racial group"], ans:0, exp:"الثقافة = مجموعة القيم والتصورات والرغبات والسلوكيات التي يتعلمها الفرد من الأسرة والمؤسسات الاجتماعية." },
  { ch:"ch1", diff:"easy", q:"Customers can be classified into four relationship groups, according to their profitability and projected loyalty. Which type of customers have the highest profit potential and strong loyalty?", opts:["true friends","strangers","butterflies","barnacles"], ans:0, exp:"الأصدقاء الحقيقيون (True friends) = أعلى ربحية محتملة + أقوى ولاء." },
  { ch:"ch2", diff:"easy", q:"Through ______, the company turns the plans into actions.", opts:["marketing planning","marketing analysis","marketing control","implementation"], ans:3, exp:"التنفيذ (implementation) = العملية التي تحول الخطط إلى أفعال فعلية." },
  { ch:"ch2", diff:"easy", q:"The ______ is the collection of businesses and products that make up the company.", opts:["business","business portfolio","financial portfolio","portfolio"], ans:1, exp:"محفظة الأعمال (business portfolio) = مجموعة الأعمال والمنتجات التي تتكون منها الشركة." },
  { ch:"ch5", diff:"easy", q:"______ is the tendency to remember good points made about a brand they favor and forget good points made about competing brands.", opts:["Selective attention","Selective distortion","Selective retention","None of the above"], ans:2, exp:"الاحتفاظ الانتقائي = الميل لتذكر المعلومات الإيجابية عن العلامة المفضلة ونسيان ما هو إيجابي عن المنافسين." },
  ...
  { ch:"ch3", diff:"easy", q:"Which of the following is the political environment?", opts:["technological","socio-legal","political","cultural"], ans:2, exp:"البيئة السياسية تشمل القوانين والوكالات الحكومية ومجموعات الضغط التي تؤثر على الأفراد والمنظمات." },

  // ── أحدث 3 تجميعات — Exam A ──
  { ch:"ch1", diff:"medium", q:"When building customer relationships, a company should invest most in ______.", opts:["Barnacles","Butterflies","Strangers","True friends"], ans:3, exp:"يجب الاستثمار الأكبر في الأصدقاء الحقيقيين لأنهم أعلى ربحيةً وأقوى ولاءً." },
  { ch:"ch1", diff:"medium", q:"The societal marketing concept seeks to establish a balance between consumer short-run wants and consumer ______.", opts:["short-run costs and profits","short-run ethics","long-run welfare","immediate health"], ans:2, exp:"المفهوم التسويقي المجتمعي يوازن بين الرغبات قصيرة الأمد والرفاهية طويلة الأمد." },
  { ch:"ch2", diff:"medium", q:"According to the simple five-step model of the marketing process, the fourth step is to ______.", opts:["Decide how to deliver superior value","Build profitable relationships with customers","Use CRM to create full partnerships with key customers","Understand the marketplace and customer needs"], ans:1, exp:"الخطوة الرابعة في نموذج التسويق الخماسي = بناء علاقات مربحة مع العملاء." },
  { ch:"ch2", diff:"medium", q:"Which is a major activity in strategic planning whereby management evaluates the products and businesses that make up the company?", opts:["long-range planning","short-range planning","Portfolio analysis","strategic planning"], ans:2, exp:"تحليل المحفظة (Portfolio analysis) = تقييم الإدارة للأعمال والمنتجات المكوّنة للشركة." },
  { ch:"ch2", diff:"medium", q:"After management has identified the key businesses making up its company, what is the next step in portfolio analysis?", opts:["identifying businesses in which to invest","assessing the attractiveness of its SBUs","deciding whether to harvest any businesses","completing short-range planning"], ans:1, exp:"بعد تحديد وحدات الأعمال، الخطوة التالية = تقييم مدى جاذبيتها." },
  { ch:"ch2", diff:"easy", q:"Which of the following can be a company division, a product line within a division, or sometimes a single product or brand?", opts:["a market","the BCG","an SBU","a PLC"], ans:2, exp:"وحدة الأعمال الاستراتيجية (SBU) يمكن أن تكون قسماً أو خطاً للمنتجات أو منتجاً واحداً." },
  { ch:"ch2", diff:"medium", q:"Identifying new markets and consumers without changing a firm's products is ______.", opts:["market attractiveness","market penetration","market development","product development"], ans:2, exp:"تطوير السوق = الوصول لأسواق جديدة بنفس المنتجات الحالية." },
  { ch:"ch2", diff:"medium", q:"STC introduced STC Pay, an online banking service. STC is exploring possibilities for ______.", opts:["market penetration","market development","diversification","harvesting"], ans:2, exp:"تقديم خدمة مصرفية جديدة بعيدة عن الاتصالات = استراتيجية التنويع (diversification)." },
  { ch:"ch3", diff:"easy", q:"You are directed to study the demographic, economic, natural, technological, political, and cultural factors that are larger societal forces affecting your company. What are you studying?", opts:["The macro environment","The microenvironment","The internal environment","The marketing mix"], ans:0, exp:"دراسة القوى الاجتماعية الكبرى = البيئة الكلية (macroenvironment)." },
  { ch:"ch3", diff:"medium", q:"Which of the following is NOT a type of factor in a company's microenvironment?", opts:["Competitors","Economic","Internal factors","Suppliers"], ans:1, exp:"العوامل الاقتصادية = بيئة كلية (macroenvironment) وليست بيئة ميكرو." },
  { ch:"ch3", diff:"medium", q:"Currently, Abdulaziz Alotaibi is employed by a firm that conducts financial studies and provides loans and insurance for other companies. Who is Abdulaziz's employer?", opts:["Financial intermediary","Physical distribution firm","Marketing service agency","A reseller"], ans:0, exp:"الشركة التي تقدم القروض والتأمين = وسيط مالي (financial intermediary)." },
  { ch:"ch3", diff:"easy", q:"Neighborhoods and community organizations are all part of a company's ______ public.", opts:["General","Internal","Local","Intermediary"], ans:2, exp:"الأحياء والمنظمات المجتمعية = الجمهور المحلي (local public)." },
  { ch:"ch3", diff:"medium", q:"Ahmed owns a coffee shop. In the past few months his suppliers have been providing less coffee because of heavy rains and flooding. The price of coffee has increased due to ______.", opts:["Supplier","Natural environment","Competitors","Economic environment"], ans:1, exp:"الفيضانات وشح القهوة = تأثير البيئة الطبيعية على سلسلة التوريد." },
  { ch:"ch3", diff:"easy", q:"Which type of organization helps companies find customers and make sales to them?", opts:["financial intermediaries","physical distribution firms","marketing services agencies","resellers"], ans:3, exp:"Resellers = وسطاء قنوات التوزيع الذين يساعدون الشركة في إيجاد العملاء أو إتمام المبيعات (مثل تجار الجملة والتجزئة). وكالات الخدمات التسويقية تساعد في الترويج وأبحاث السوق — لا في البيع المباشر." },
  { ch:"ch3", diff:"medium", q:"Trends in the natural environment include all of the following EXCEPT:", opts:["Shortage of raw materials","Increased pollution","Decreased cost of product development","Increased government intervention"], ans:2, exp:"انخفاض تكلفة تطوير المنتج ليس اتجاهًا في البيئة الطبيعية — الاتجاهات الحقيقية: شح الموارد، التلوث، تدخل الحكومة." },
  { ch:"ch5", diff:"medium", q:"According to the model of buyer behavior, which of the following is one of the two primary parts of a 'buyer's black box'?", opts:["buyer's characteristics","buyer's spending habits","buyer's feelings","buyer's personality"], ans:0, exp:"الصندوق الأسود = جزأان: خصائص المشتري وعملية اتخاذ القرار الشرائي." },
  { ch:"ch5", diff:"easy", q:"______ are groups to which an individual wishes to belong, as when a teenage football player hopes to play someday for a famous club.", opts:["Social class groups","Aspirational groups","Leading adopter groups","Membership groups"], ans:1, exp:"المجموعات التطلعية = التي يتمنى الفرد الانتماء إليها مستقبلاً." },
  { ch:"ch5", diff:"medium", q:"Khalid loves to drink coffee. Every day he goes to a new coffee shop. Khalid is experiencing ______.", opts:["Dissonance-reducing buying behavior","Variety seeking buying behavior","Complex buying behavior","Habitual buying behavior"], ans:1, exp:"تنويع خالد في اختيار المقاهي = سلوك البحث عن التنويع (variety seeking buying behavior)." },
  { ch:"ch5", diff:"medium", q:"Shawarmer introduced a new meal called 'The Salim', featuring Al-Hilal player Salim Al-Dosari. This is an example of ______.", opts:["buzz marketing","habitual marketing","social media marketing","complex marketing"], ans:0, exp:"استخدام شخصية مشهورة لإثارة الحديث حول منتج = التسويق بالإثارة (buzz marketing)." },

  // ── أحدث 3 تجميعات — Exam C ──
  { ch:"ch1", diff:"medium", q:"Sultan now has the purchasing power to purchase the laptop he has wanted for the last six months. Sultan's want now has become a(n) ______.", opts:["Personal needs","Social needs","Physiological need","Demand"], ans:3, exp:"الرغبة المدعومة بالقدرة الشرائية تصبح طلبًا فعليًا (demand)." },
  { ch:"ch1", diff:"medium", q:"'How shall we serve our target market?' is a question asked to identify a company's ______.", opts:["Market segment","Target market","Value proposition","None of the above"], ans:2, exp:"سؤال 'كيف نخدم سوقنا؟' يُستخدم لتحديد عرض القيمة (value proposition)." },
  { ch:"ch1", diff:"medium", q:"In the context of customer relationship groups, a potentially profitable and short-term loyal customer is referred to as a ______.", opts:["Barnacles","Butterflies","Strangers","True friends"], ans:1, exp:"الفراشات (butterflies) = عملاء مربحون محتملون لكن ولاؤهم قصير الأمد." },
  { ch:"ch1", diff:"medium", q:"Hamd Al Hamdan of Saudi Airlines used the marketing concept in running his successful organization. Having a customer department rather than a marketing department reflects a(n) ______ perspective.", opts:["Inside-out","Outside-in","Traditional","Product-focused"], ans:1, exp:"قسم للعملاء بدلاً من قسم التسويق = منظور 'من الخارج للداخل' (outside-in) يبدأ من احتياجات العميل." },
  { ch:"ch2", diff:"medium", q:"Al-Baik fast food chain has successfully launched stores in Riyadh, Al Qassim, UAE and Egypt. This is an example of how Al-Baik is pursuing ______ as a growth strategy.", opts:["market penetration","product development","demographic market development","market development"], ans:3, exp:"التوسع في أسواق جغرافية جديدة بنفس المنتجات = تطوير السوق (market development)." },
  { ch:"ch2", diff:"medium", q:"For Hyundai Corporation, customers who care about the price of a car and its operating economy make up one ______.", opts:["market position","market segment","value chain","SWOT analysis"], ans:1, exp:"عملاء يشتركون في الاهتمام بالسعر والاقتصاد يشكلون شريحة سوقية متجانسة." },
  { ch:"ch2", diff:"medium", q:"Introducing new products to the same markets and consumers is ______.", opts:["market attractiveness","market penetration","market development","product development"], ans:3, exp:"تقديم منتجات جديدة للأسواق الحالية = تطوير المنتج (product development)." },
  { ch:"ch2", diff:"medium", q:"Honda Motor Co. and Walmart have designed programs to work closely with their suppliers to help them reduce costs and improve quality. This illustrates the importance of an effective ______.", opts:["business portfolio","low-cost operator","Value chain","value delivery network"], ans:3, exp:"تعاون هوندا وولمارت مع مورديهم = شبكة تسليم القيمة (value delivery network)." },
  { ch:"ch3", diff:"medium", q:"Which of the following is NOT a type of factor in a company's macro environment?", opts:["Demographic","Economic","Internal factors","Political"], ans:2, exp:"العوامل الداخلية = بيئة داخلية، ليست جزءًا من الماكرو بيئة." },
  { ch:"ch3", diff:"medium", q:"Currently, Abdulaziz is employed by a firm that conducts marketing research and creates advertisements for other companies. Who is Abdulaziz's employer?", opts:["Financial intermediary","Physical distribution firm","Marketing service agency","A reseller"], ans:2, exp:"الشركة التي تقوم بأبحاث التسويق وصناعة الإعلانات = وكالة خدمات تسويقية." },
  { ch:"ch3", diff:"easy", q:"Workers, managers, and members of the board are all part of a company's ______ public.", opts:["General","Internal","Local","Intermediary"], ans:1, exp:"الموظفون والمدراء وأعضاء مجلس الإدارة = الجمهور الداخلي (internal public)." },
  { ch:"ch3", diff:"medium", q:"Business legislation has been created for three basic reasons: to protect companies from each other, to protect consumers, and to ______.", opts:["Protect the interests of society","Regulate prices","Increase world trade","Regulate monopolies"], ans:0, exp:"التشريعات التجارية تهدف لحماية الشركات من بعضها، وحماية المستهلكين، وحماية مصالح المجتمع." },
  { ch:"ch3", diff:"easy", q:"The ______ environment consists of economic factors that affect consumer purchasing power and spending patterns.", opts:["Cultural","Technological","Political","Economic"], ans:3, exp:"البيئة الاقتصادية تشمل العوامل التي تؤثر على القدرة الشرائية وأنماط الإنفاق." },
  { ch:"ch5", diff:"easy", q:"The starting point to understanding how consumers respond to various marketing efforts is the ______ model of buyer behavior.", opts:["Subculture","Belief","Post purchase feeling","Stimulus-response"], ans:3, exp:"نموذج المحفز-الاستجابة (stimulus-response) = نقطة البداية لفهم تفاعل المستهلك مع التسويق." },
  { ch:"ch5", diff:"medium", q:"All of the following make up a person's lifestyle EXCEPT ______.", opts:["Dissonance-reducing buying behavior","Interests","Opinions","AIO dimensions"], ans:0, exp:"نمط الحياة يُقاس بـ AIO (أنشطة، اهتمامات، آراء). سلوك تخفيض التنافر = نوع قرار شراء، ليس مكوناً لنمط الحياة." },
  { ch:"ch5", diff:"medium", q:"If a consumer's experience is rewarding, that consumer will probably use the product repeatedly. The consumer's response to the product will be ______.", opts:["an attitude","a belief","reinforced","a dissonant experience"], ans:2, exp:"التجربة المكافئة تُعزّز استجابة المستهلك نحو المنتج، مما يجعله يستخدمه بشكل متكرر." },
  { ch:"ch5", diff:"medium", q:"People tend to interpret new information in a way that will support what they already believe, called ______.", opts:["selective retention","selective distortion","selective attitude","selective attention"], ans:1, exp:"التشويه الانتقائي = تفسير المعلومات الجديدة بطريقة تتوافق مع المعتقدات السابقة." },

  // ── New questions from past exams (extracted 2026) ──

  // Ch1
  { ch:"ch1", diff:"easy", q:"TRUE or FALSE: Consumers in different countries have the same needs, wants, and demands.", opts:["True","False"], ans:1, exp:"خطأ — الاحتياجات الأساسية (needs) مشتركة، لكن الرغبات (wants) تختلف من ثقافة لأخرى. والطلب (demand) يتأثر بالدخل والأسعار التي تختلف بين الدول.", expW:{} },
  { ch:"ch1", diff:"medium", q:"Which of the following is NOT a core concept of marketing?", opts:["Needs, wants, and demands","Market offerings","Value and satisfaction","Promotion","Exchanges and relationships"], ans:3, exp:"المفاهيم الجوهرية الخمسة للتسويق: الحاجات والرغبات والطلب، عروض السوق، القيمة والرضا، التبادلات والعلاقات، والأسواق. الترويج (Promotion) ليس أحد المفاهيم الجوهرية — بل هو عنصر من عناصر المزيج التسويقي.", expW:{0:"أول المفاهيم الجوهرية",1:"ثاني المفاهيم الجوهرية",2:"ثالث المفاهيم الجوهرية",4:"رابع المفاهيم الجوهرية"} },

  // Ch2
  { ch:"ch2", diff:"medium", q:"_____ is the degree to which a market segment is large or profitable enough to serve.", opts:["Measurability","Substantiality","Accessibility","Differentiability","Actionability"], ans:1, exp:"Substantiality = الحجم الكافي: الشريحة يجب أن تكون كبيرة أو مربحة بما يكفي لتبرير استهدافها. إذا كانت الشريحة صغيرة جداً لن تغطي تكاليف التسويق.", expW:{0:"Measurability = القدرة على قياس الحجم والقوة الشرائية",2:"Accessibility = القدرة على الوصول إلى الشريحة",3:"Differentiability = تمييز الشريحة عن غيرها",4:"Actionability = القدرة على تصميم برامج فعّالة"} },
  { ch:"ch2", diff:"medium", q:"_____ is the extent to which a market segment can be effectively reached and served.", opts:["Measurability","Substantiality","Accessibility","Differentiability","Actionability"], ans:2, exp:"Accessibility = إمكانية الوصول: يجب أن تكون الشريحة في متناول الشركة عبر قنوات التوزيع والترويج المتاحة.", expW:{0:"Measurability = القدرة على قياس الحجم والقوة الشرائية",1:"Substantiality = الشريحة كبيرة ومربحة بما يكفي",3:"Differentiability = تمييز الشريحة عن غيرها",4:"Actionability = القدرة على تصميم برامج فعّالة"} },
  { ch:"ch2", diff:"medium", q:"_____ is the degree to which the size, purchasing power, and profiles of a market segment can be measured.", opts:["Measurability","Substantiality","Accessibility","Differentiability","Actionability"], ans:0, exp:"Measurability = قابلية القياس: يجب أن تكون حجم الشريحة وقوتها الشرائية وملفها الشخصي قابلة للقياس. مثلاً، يصعب قياس شريحة 'المراهقين ذوو التفكير الإيجابي' بدقة.", expW:{1:"Substantiality = الشريحة كبيرة ومربحة بما يكفي",2:"Accessibility = القدرة على الوصول إلى الشريحة وخدمتها",3:"Differentiability = تمييز الشريحة عن غيرها",4:"Actionability = القدرة على تصميم برامج فعّالة"} },
  { ch:"ch2", diff:"medium", q:"With a(n) _____ marketing strategy, a firm goes after a large share of one or a few smaller niches.", opts:["undifferentiated","differentiated","concentrated","micromarketing","mass"], ans:2, exp:"التسويق المركّز (Concentrated/Niche marketing) = الشركة تركّز مواردها على شريحة واحدة صغيرة أو عدد قليل من الشرائح الصغيرة لتحقيق حصة سوقية كبيرة فيها.", expW:{0:"Undifferentiated = نفس العرض لكل السوق",1:"Differentiated = عروض مختلفة لشرائح مختلفة",3:"Micromarketing = تخصيص للأفراد أو المناطق المحلية",4:"Mass = نفس المعنى تقريباً للـ undifferentiated"} },
  { ch:"ch2", diff:"medium", q:"'To busy multitaskers who need help remembering things, Evernote is a digital content management application that makes it easy to capture and remember things across any device, anywhere.' This is an example of a(n) _____.", opts:["order-routine specification","vision statement","product specification","mission statement","positioning statement"], ans:4, exp:"Positioning statement = بيان التمركز: يصف الجمهور المستهدف (multitaskers)، اسم العلامة (Evernote)، الفئة (digital content management)، ونقطة التميّز (easy to capture across devices). هذا هو التنسيق الكلاسيكي لبيان التمركز.", expW:{0:"Order-routine specification = مصطلح في الشراء التنظيمي B2B",1:"Vision statement = رؤية مستقبلية للشركة",2:"Product specification = مواصفات تقنية للمنتج",3:"Mission statement = غرض وجود الشركة"} },

  // Ch3
  { ch:"ch3", diff:"medium", q:"Marketers need to know about the major types of customers that a company's marketing intermediaries sell to. Which of the following is NOT one of the five main customer markets?", opts:["Consumer markets","Business markets","Government markets","Reseller markets","Internal markets"], ans:4, exp:"الأسواق الخمسة الرئيسية: (1) Consumer markets، (2) Business markets، (3) Reseller markets، (4) Government markets، (5) International markets. 'Internal markets' ليست من بينها — الأسواق الداخلية ليست نوعاً من أسواق العملاء.", expW:{0:"أسواق المستهلكين النهائيين للاستهلاك الشخصي",1:"أسواق الأعمال للإنتاج أو العمليات",2:"أسواق الحكومة للخدمات العامة",3:"أسواق الموزعين لإعادة البيع"} },

  // Ch5
  { ch:"ch5", diff:"medium", q:"Which of the following is NOT a type of consumer buying behavior?", opts:["Complex buying behavior","Dissonance-reducing buying behavior","Habitual buying behavior","Rational buying behavior","Variety-seeking buying behavior"], ans:3, exp:"أنواع سلوك الشراء الأربعة في Kotler: (1) Complex، (2) Dissonance-reducing، (3) Habitual، (4) Variety-seeking. 'Rational buying behavior' ليس نوعاً معترفاً به ضمن هذا التصنيف الرباعي.", expW:{0:"Complex = تورط عالٍ + فروق كبيرة بين الماركات",1:"Dissonance-reducing = تورط عالٍ + فروق قليلة",2:"Habitual = تورط منخفض + فروق قليلة",4:"Variety-seeking = تورط منخفض + فروق كبيرة"} },
  { ch:"ch5", diff:"medium", q:"Which of the following is NOT a psychological factor affecting consumer buyer behavior?", opts:["Beliefs and attitudes","Motivation","Groups and social networks","Learning","Perception"], ans:2, exp:"العوامل النفسية الأربعة: الدافعية (motivation)، الإدراك (perception)، التعلم (learning)، المعتقدات والمواقف (beliefs & attitudes). المجموعات والشبكات الاجتماعية = عوامل اجتماعية (social factors)، وليست نفسية.", expW:{0:"Beliefs & attitudes = عوامل نفسية",1:"Motivation = دافعية (عامل نفسي)",3:"Learning = تعلم (عامل نفسي)",4:"Perception = إدراك (عامل نفسي)"} },
  { ch:"ch5", diff:"easy", q:"Individuals and households that buy or acquire goods and services for personal consumption make up the _____.", opts:["social class","consumer market","market offering","subculture","business market"], ans:1, exp:"Consumer market = سوق المستهلكين: جميع الأفراد والأسر الذين يشترون السلع والخدمات للاستهلاك الشخصي. هم المستهلكون النهائيون وموضوع دراسة سلوك المستهلك.", expW:{0:"Social class = تقسيم اجتماعي بالدخل والتعليم",2:"Market offering = ما تقدمه الشركة للسوق",3:"Subculture = مجموعة ثقافية فرعية",4:"Business market = يشتري للإنتاج أو إعادة البيع"} },
  { ch:"ch5", diff:"easy", q:"According to Maslow's hierarchy of needs, the most pressing needs that must be satisfied first are _____.", opts:["safety needs","social needs","esteem needs","physiological needs","self-actualization needs"], ans:3, exp:"هرم ماسلو من الأكثر إلحاحاً للأقل: (1) Physiological — طعام، ماء، مأوى (الأكثر إلحاحاً)، (2) Safety، (3) Social، (4) Esteem، (5) Self-actualization (الأقل إلحاحاً). الفرد يُشبع الأدنى قبل أن يتحرك للأعلى.", expW:{0:"Safety = المستوى الثاني",1:"Social = المستوى الثالث",2:"Esteem = المستوى الرابع",4:"Self-actualization = القمة والأقل إلحاحاً"} },

  // ── Past exams: 1442ب + 1444أ (newly extracted, dedup verified) ──
  { ch:"ch2", diff:"easy", q:"The IKEA's ______ maps (outlines) which customers it will serve and how it will create value for these customers.", opts:["Customer relationship management","Vision statement","Marketing strategy","Marketing program","Mission statement"], ans:2, exp:"استراتيجية التسويق (Marketing strategy) تحدد العملاء المستهدفين وكيف ستنشئ الشركة قيمة لهم.", expW:{0:"CRM = إدارة علاقات العملاء الحاليين",1:"Vision = طموح الشركة المستقبلي",3:"Marketing program = تنفيذ المزيج التسويقي 4Ps",4:"Mission = سبب وجود الشركة"} },
  { ch:"ch1", diff:"medium", q:"AbdulAziz Al-Tamimi, the Chairman of a highly successful regional supermarket chain — Tamimi Markets, doesn't like losing even a single customer. He feels that this amounts to losing the entire stream of future purchases that a customer is likely to make if he or she remains in the area. AbdulAziz Al-Tamimi's concern is an illustration of which of the following?", opts:["Marketing segmentation","Production","Product planning","Customer lifetime value"], ans:3, exp:"قيمة العميل مدى الحياة (Customer Lifetime Value) = مجموع التدفقات النقدية/الأرباح المستقبلية المتوقعة من العميل طوال فترة ارتباطه بالشركة. خسارة عميل واحد = خسارة كل مشترياته المستقبلية.", expW:{0:"Segmentation = تقسيم السوق إلى شرائح",1:"Production = التصنيع، مب سلوك عملاء",2:"Product planning = تخطيط المنتج"} },
  { ch:"ch2", diff:"easy", q:"\"How shall we serve our target market?\" is a question asked to identify a company's ______.", opts:["Market segment","Target market","Value proposition","None of the above"], ans:2, exp:"القيمة المقترحة (Value Proposition) تجيب على سؤال: كيف سنخدم السوق المستهدف وما الذي يميزنا؟ هي مجموعة الفوائد التي تعد الشركة العملاء بتقديمها.", expW:{0:"Market segment = الشريحة نفسها",1:"Target market = من سنخدم (وليس كيف)",3:"خيار موجود صحيح"} },
  { ch:"ch2", diff:"medium", q:"All of the following are accurate about what a mission statement should be EXCEPT ______.", opts:["Be motivating","Product oriented","Be meaningful and specific","Emphasize company's strength"], ans:1, exp:"بيان الرسالة الجيد يجب أن يكون موجهاً للسوق (market-oriented) وليس للمنتج (product-oriented). التوجه للمنتج يؤدي إلى marketing myopia.", expW:{0:"محفز = صحيح",2:"ذو معنى ومحدد = صحيح",3:"يبرز نقاط قوة الشركة = صحيح"} },
  { ch:"ch2", diff:"medium", q:"Disney is identifying and developing new markets ______ for its theme parks. Disney is exploring possibilities for ______.", opts:["Market penetration","Market segmentation","Diversification","Market development"], ans:3, exp:"تطوير السوق (Market Development) = أسواق جديدة + منتج حالي. ديزني تفتح أسواقاً جغرافية/ديموغرافية جديدة لمنتجها الحالي (مدن الملاهي).", expW:{0:"Penetration = سوق حالي + منتج حالي",1:"Segmentation = تقسيم، ليست ضمن Ansoff matrix",2:"Diversification = سوق جديد + منتج جديد"} },
  { ch:"ch3", diff:"medium", q:"A regional supermarket chain — Panda Supermarkets runs print, radio, and television advertisements highlighting the perils (dangers) of chatting while driving. This is an example of ______ marketing.", opts:["Cause-related","Generational","Sustainable","Tiered"], ans:0, exp:"التسويق المرتبط بقضية (Cause-related marketing) = ربط الشركة بقضية اجتماعية مهمة (هنا: السلامة على الطريق).", expW:{1:"Generational = موجه لجيل معين",2:"Sustainable = استدامة بيئية طويلة المدى",3:"Tiered = مستويات أسعار"} },
  { ch:"ch3", diff:"medium", q:"Value marketing is the strategy of offering consumers ______.", opts:["High quality at a high price","Luxury quality at a high price","Lesser quality at a low price","Reasonable quality at a fair price"], ans:3, exp:"التسويق القائم على القيمة (Value marketing) = تقديم جودة معقولة بسعر عادل — معادلة value = benefits / price.", expW:{0:"جودة عالية بسعر عالٍ = premium",1:"فاخر بسعر عالٍ = luxury",2:"جودة أقل بسعر منخفض = cheap، مب value"} },
];
...
function exportChapterBinder(pageId, chapterTitle) {
  ...
  // ── Color palette — study-optimized ───────────────────────────
  const C = {
    // Primary teal
    c1:'#0F766E', c2:'#0D9488', cLight:'#CCFBF1', cBg:'#F0FDFA',
    // Definition — blue
    defBorder:'#2563EB', defBg:'#EFF6FF', defTerm:'#1E3A8A', defBody:'#1E40AF',
    // Exam tip — amber (most important)
    tipBg:'#FFFBEB', tipBorder:'#F59E0B', tipAccent:'#B45309', tipText:'#78350F',
    // Memory box — purple
    memoBg:'#FAF5FF', memoBorder:'#7C3AED', memoText:'#4C1D95',
    // Example box — green
    exBg:'#F0FDF4', exBorder:'#16A34A', exText:'#14532D',
    // From-notes — indigo
    notesBg:'#EEF2FF', notesBorder:'#4F46E5', notesText:'#312E81',
    // General
    ink:'#111827', muted:'#6B7280', line:'#E5E7EB',
    loHeaderBg:'#0C4A6E', loHeaderText:'#FFFFFF',
  };
  ...
  // ── Build LO quick-summary from key terms in lo-body ──────────
  function buildQuickSummary(body) {
    const terms = [];
    body.querySelectorAll('.def-term, .master-card > strong, .concept-card > strong').forEach(el => {
      const t = el.textContent.replace(/📌/g,'').trim();
      if (t && t.length < 80) terms.push(t);
    });
    if (!terms.length) return '';
    const items = terms.slice(0,6).map(t => `<span class="qs-tag">${t}</span>`).join('');
    return `<div class="quick-summary">🔑 Key Terms: ${items}</div>`;
  }
  ...
  function walkChildren(container) {
    ...
    for (const el of container.children) {
      ...
      if (tag === 'H3') {
        ...
        const { mainHtml, arText } = extractAr(el);
        html += `<div class="memo"><span class="memo-icon">💡</span><div class="memo-body">${mainHtml}${arDiv(arText)}</div></div>`;
      }

      else if (cls.includes('exam-tip')) {
        const { mainHtml, arText } = extractAr(el);
        html += `<div class="tip"><div class="tip-label">⭐ سيُسأل في الامتحان</div><div class="tip-body">${mainHtml}${arDiv(arText)}</div></div>`;
      }
        ...
        if (inner.trim()) html += `<div class="${blockCls}">${badge}${inner}</div>`;
      }
  ...
  for (const el of page.children) {
    ...
    if (cls.includes('chapter')) {
      ...
      // Extract English and Arabic title separately
      let titleEn = '', titleAr = '';
      if (titleEl) {
        const arSpan = titleEl.querySelector('.ar-line, span[style]');
        titleAr = arSpan ? arSpan.textContent.trim() : '';
        const tc = titleEl.cloneNode(true);
        if (arSpan) tc.querySelectorAll('.ar-line, span[style]').forEach(a => a.remove());
        titleEn = tc.textContent.trim();
      }
      contentHtml += '<div class="lo-section-pdf">';
      contentHtml += `<div class="lo-header-pdf">
        <div class="lo-badge-num">${badgeText}</div>
        <div class="lo-title-wrap">
          <div class="lo-title-en">${titleEn}</div>
          ${titleAr ? `<div class="lo-title-ar">${titleAr}</div>` : ''}
        </div>
      </div>`;
      if (body) {
        contentHtml += buildQuickSummary(body);
        contentHtml += '<div class="lo-content">';
        contentHtml += walkChildren(body);
        contentHtml += '</div>';
      }
      contentHtml += '</div>';
    }
...
.concept-block.purple{ border-left-color:#7C3AED;background:#FAF5FF; } .concept-block.purple strong { color:#5B21B6; }
