...
const pastQuestions = [
  ...
  { ch:"ch2", diff:"medium", q:"What is the marketing term for a relatively small, well-defined, and very focused target market?", opts:["A mass market","A customized market","A targeted market","A differentiated market","A niche market"], ans:4, exp:"Niche market = سوق متخصص صغير ومحدد جيداً. الشركات التي تخدم niches تقدم عروضاً متخصصة لمجموعات صغيرة ذات احتياجات محددة.", expW:{0:"Mass market = السوق الواسع بدون تمييز",1:"Customized market = تخصيص فردي",2:"Targeted market = عام جداً",3:"Differentiated market = عروض متعددة لشرائح متعددة"} },
  ...
  { ch:"ch2", diff:"medium", q:"Through _____ differentiation, brands can be differentiated on features, performance, or style and design.", opts:["image","services","people","channel","product"], ans:4, exp:"Product differentiation = تمييز المنتج بناءً على المميزات (features)، الأداء (performance)، أو الأسلوب والتصميم (style & design). هذا أحد أنواع التمييز الخمسة الرئيسية.", expW:{0:"Image differentiation = التمييز بالصورة الذهنية",1:"Services differentiation = التمييز بخدمة ما بعد البيع",2:"People differentiation = التمييز بجودة الموظفين",3:"Channel differentiation = التمييز بقنوات التوزيع"} },
  { ch:"ch2", diff:"medium", q:"Which of the following is a disadvantage of using a differentiated marketing strategy?", opts:["Customer loyalty is negatively impacted","Quality control problems increase","Product safety decreases","The costs of doing business increase","Generates far lower sales compared to undifferentiated"], ans:3, exp:"Differentiated marketing = عروض مختلفة لشرائح مختلفة. العيب الرئيسي: تزداد تكاليف الأعمال (بحث، تطوير، إنتاج، تسويق منفصل لكل شريحة). وهو أغلى من التسويق الموحّد.", expW:{0:"الولاء لا يتأثر سلباً بل يزيد عادةً مع التخصيص",1:"مشاكل الجودة ليست نتيجة مباشرة للتمييز",2:"سلامة المنتج لا تقل",4:"المبيعات عادةً أعلى مع التمييز لا أقل"} },
  { ch:"ch2", diff:"medium", q:"Which of the following is true about multivariable segmentation systems?", opts:["Multiple segmentation is ineffective in large markets","Marketers using multiple segmentation bases tend to ignore smaller markets","Multiple segmentation rarely involves the use of demographic data","Marketers use multiple segmentation bases to control inflation","Multiple segmentation bases help identify smaller, better-defined target groups"], ans:4, exp:"Multivariable segmentation = استخدام متغيرات تقسيم متعددة في آنٍ واحد. يُنتج شرائح أصغر وأكثر دقة وتحديداً. مثلاً: جمع العمر + الدخل + نمط الحياة لتحديد الشريحة.", expW:{0:"أكثر فاعلية خاصةً في الأسواق الكبيرة",1:"يُسهم في اكتشاف شرائح صغيرة",2:"البيانات الديموغرافية غالباً جزء أساسي منه",3:"لا علاقة له بالتضخم الاقتصادي"} },
  ...
  { ch:"ch5", diff:"easy", q:"The energizing force that activates behavior and provides purpose and direction to that behavior is known as _____.", opts:["Emotion","Personality","Motivation","Attitude","Perception"], ans:2, exp:"الدافعية (Motivation) = القوة المُحفِّزة التي تُنشِّط السلوك وتُعطيه هدفاً واتجاهاً. هي التي تدفع الفرد للتصرف بهدف تلبية حاجة مُلحّة.", expW:{0:"Emotion = انفعال لحظي",1:"Personality = شخصية ثابتة نسبياً",3:"Attitude = موقف تقييمي",4:"Perception = عملية تفسير المعلومات"} },
  { ch:"ch5", diff:"medium", q:"Cognitive dissonance is caused by conflict during _____.", opts:["pre-purchase evaluation","the purchase decision","information search","alternative evaluation","post-purchase behavior"], ans:4, exp:"Cognitive dissonance = التنافر المعرفي يحدث في مرحلة ما بعد الشراء (post-purchase). العميل يشعر بالقلق والشك بعد اتخاذ قرار الشراء ويبحث عن تأكيد أنه اتخذ القرار الصحيح.", expW:{0:"Pre-purchase = قبل الشراء، قبل حدوث التنافر",1:"Purchase decision = لحظة الشراء، التنافر لم يظهر بعد",2:"Information search = المرحلة الثانية قبل الشراء",3:"Alternative evaluation = المرحلة الثالثة قبل الشراء"} },
